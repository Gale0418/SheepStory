...
Every idea must be routed to at least one of:
...
Exports a structured prompt for `my-novel-writing`.
...
- A chapter cannot draft until it has a contract.
...
- After drafting, memory updates are mandatory.
