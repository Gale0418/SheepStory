...
Dialogue should reveal character through pressure, intention, obstacle, and subtext. It should not merely deliver information.

## Core Model

For each important exchange, define:
...
- a character says their emotional state too directly
...
Dialogue is not people exchanging information. Dialogue is people trying to move each other.
