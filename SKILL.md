...
33. Stealth foreshadowing may hide clue significance from characters and first-time readers, but it must not silently invent major canon. The underlying reveal must already be approved or explicitly delegated; a good twist may hide the answer, not the existence of the rules required to produce it.
34. Major mistakes should belong to character, information, pressure, resources, or opponent manipulation rather than arbitrary competence loss. Do not use repeated ally carelessness to create danger or enemy carelessness to create victory unless the behavior has a causal reason.
35. For a major resolution, distinguish existence fairness, causal fairness, agency fairness, competence fairness, catharsis fit, and reader-promise fit. An established outside force or remote system can still be an unsatisfying climax if it bypasses the contest the story trained the reader to care about without prepared thematic reason.
36. Run an honest credit/MVP check on major victories and defeats: identify who created the decisive option, who acted, and whether emotional credit matches causal credit. Let coincidence create trouble or an opening more freely than it solves the climax.

## Reference Routing

- Planning: `skills/sheep-story/references/outline-gate.md`, `skills/sheep-story/references/conflict-pressure.md`, plus `skills/sheep-story/references/story-architecture.md` for complete arcs, `skills/sheep-story/references/ending-outcome-model.md` for finales or mixed ending outcomes, `skills/sheep-story/references/earned-resolution-foreshadowing.md` for twists, clue/payoff architecture, fair-play reveals, competence-sensitive mistakes, or climax-resolution causality, and `skills/sheep-story/references/opposition-design.md` for persistent opposition.
...
- Stealth clue placement, foreshadowing fairness, setup/payoff, deus/diabolus-ex-machina risk, fair-play mystery, character-consistent or induced mistakes, competence collapse, coincidence, causal credit, MVP checks, or climax-modality displacement: `skills/sheep-story/references/earned-resolution-foreshadowing.md`.
...
- Drafting: `skills/sheep-story/references/voice-calibration.md`, `style-preservation.md`, plus task-specific references. For approved stealth foreshadowing or a major payoff, also load `earned-resolution-foreshadowing.md`.
- Editorial rewrite: `skills/sheep-story/references/editorial-rewrite.md`, `voice-calibration.md`, and `style-preservation.md`.
- Review: `skills/sheep-story/references/review-rubric.md`, `style-preservation.md`, plus visible failure-mode references. Use `earned-resolution-foreshadowing.md` for unfair reveals, convenient mistakes, sudden powers, passive victories, or established-but-unsatisfying solutions.
- Memory: `skills/sheep-story/references/story-memory-ops.md`, `continuity-check.md`, plus character dynamics, memory/belief, misunderstanding, reader-promise, ending-outcome, condition, or tracked-promise references when those states changed.
- Cockpit routing: `skills/sheep-story/references/story-cockpit-workflow.md`.
- Authoring experiments: `skills/sheep-story/references/authoring-laboratory.md` (reader simulation, sandbox-only characters, alternate takes, candidate twists, and bridge writing).
...
Laboratory, advisory, ending-analysis, reveal-analysis, recovery, and extension work remains Markdown-only and contract-only. Consensus, parser output, public-card ratings, player reviews, analytical ending labels, and candidate twists are evidence or proposals, not canon or proof of causality; canonical files remain the single truth source and require explicit authorization for mutation.
